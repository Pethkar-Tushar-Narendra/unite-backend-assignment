...
exports.getInsights = exports.getAgentPerformance = exports.getDailySummary = void 0;
...
const getDailySummary = async (req, res) => {
    try {
        ...
        const summary = await callLog_model_1.CallLog.aggregate([
            {
                $match: {
...
const getAgentPerformance = async (req, res) => {
    try {
        ...
        const agentStats = await callLog_model_1.CallLog.aggregate([
            {
                $match: matchStage,
            },
            {
...
const getInsights = async (req, res) => {
    try {
        ...
        // Find busiest agent
        const busiestAgent = await callLog_model_1.CallLog.aggregate([
            {
                $group: {
                    _id: '$agent_id',
                    agent_name: { $first: '$agent_name' },
        ...
        const completionStats = await callLog_model_1.CallLog.aggregate([
            {
                $group: {
                    _id: null,
                    total: { $sum: 1 },
        ...
        const dailyTrend = await callLog_model_1.CallLog.aggregate([
            {
                $match: {
